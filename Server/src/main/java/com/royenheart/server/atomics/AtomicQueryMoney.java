 ...
 * @author RoyenHeart
 */
public class AtomicQueryMoney extends AtomicOperations {

    private final Connection con;
    private final String tables;
    private final String accountId;

    public AtomicQueryMoney(Connection con, String tables, String accountId) {
        this.con = con;
        this.tables = tables;
    ...
    public LinkedList<HashMap<String, String>> query() throws SQLException {
        ...
        return gson.fromJson(r1, new TypeToken<LinkedList<HashMap<String, String>>>() {
        }.getType());
    }
}
